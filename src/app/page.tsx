...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-cream rounded-xl hover:shadow-lg transition-shadow duration-300">
      ...
      {/* Products Preview */}
      <section className="py-24 bg-olive-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-olive-dark mb-4">
              Nuestros Productos
            ...
            <Link
              href="/productos"
              className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-olive-primary hover:bg-olive-dark transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
