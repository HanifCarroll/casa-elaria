  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        shouldUseWhite
          ? "bg-white border-b border-olive-primary/10"
          : "bg-transparent"
      }`}
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-10">
          <Link
            href="/"
            className="absolute left-1/2 transform -translate-x-1/2 py-4"
          >
            <Image
              src={
          ...
          <button
            className={`md:hidden transition-colors ml-auto ${
              shouldUseTransparent
                ? "text-white/80 hover:text-white"
                : "text-olive-dark/80 hover:text-gold"
            }`}
        ...
        {/* Desktop Menu */}
        <div
          className={`hidden md:flex justify-center space-x-12 lg:space-x-16 py-4 ${
            shouldUseTransparent
              ? "border-t border-white/10"
              : "border-t border-olive-primary/10"
          }`}
        >
          <Link
            href="/"
            className={`font-medium tracking-wider text-base transition-colors ${
              shouldUseTransparent
                ...
                : "text-olive-dark/90 hover:text-gold"
            }`}
          >
            Inicio
          </Link>
