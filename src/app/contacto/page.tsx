        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Contact Details */}
              <div className="bg-olive-primary/5 rounded-lg p-8">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="w-10 h-10 bg-olive-primary/10 rounded-full flex items-center justify-center hover:bg-olive-primary hover:text-white transition-colors"
                  >
